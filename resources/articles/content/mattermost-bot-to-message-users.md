...
hero: hero-image.jpg
excerpt: Using the Mattermost API this bot will be able to send messages to any user
tags: [api, automation, mattermost]
image: /articles/img/ogimages/mattermost-bot-to-message-users.webp
---
...
![The grid icon dropdown in a Mattermost app](integrations.png)

---

You will have a couple of options to choose from:

![The integrations menu of Mattermost](integrations-bot-account.png)
...
![A form you have to fill out to create a Mattermost bot account](mattermost-bot-form.png)
...
![The success message includes your bots token](mattermost-bot-token.png)
