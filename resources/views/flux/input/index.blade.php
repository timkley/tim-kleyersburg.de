...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Border...
        'outline' => $invalid ? 'border-red-400' : 'shadow-xs border-zinc-200 border-b-zinc-300/80 disabled:border-b-zinc-200 dark:border-white/10 dark:disabled:border-white/5',
