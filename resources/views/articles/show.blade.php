...
<div class="prose mx-auto mb-24 lg:prose-lg dark:prose-invert prose-headings:font-ibm prose-headings:font-semibold md:mt-8 lg:mt-16">
    ...
    @if ($frontmatter->rambling)
        <x-alert
            ...
            :markdown="false"
        >
            <p>While writing this post the author was rambling inside his head. If you want to read the rambling thoughts, click the button below.</p>
            <flux:button wire:click="ramble">Turn {{ $rambling ? 'off' : 'on' }} rambling</flux:button>
        </x-alert>
    @endif
