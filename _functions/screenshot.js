// from https://github.com/11ty/api-screenshot/blob/c9e96620bdba1c9638b076b705e5342c6df01f19/functions/screenshot.js
...
async function handler(event, context) {
	const pathSplit = event.path.split('/').filter((entry) => !!entry)
	let url = pathSplit[pathSplit.length - 1]
