        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            @foreach($printQueue as $item)
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <flux:modal name="image-{{ $item->id }}" class="md:w-auto">
                        <div class="max-w-4xl mx-auto">
                            @if($imageExists)
                                <img src="{{ $imageUrl }}" alt="Print Queue Item #{{ $item->id }}" class="w-full h-auto">
                            @else
                                    ...
                                    <div class="text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <div class="mt-1 space-y-1">
                                            @foreach($item->actions as $action)
                                                <a href="{{ $action }}" 
                                                   class="inline-block px-2 py-1 text-xs bg-blue-100 dark:bg-blue-800 text-blue-800 dark:text-blue-200 rounded hover:bg-blue-200 dark:hover:bg-blue-700 transition-colors">
                    ...
                    <div class="cursor-pointer" flux:modal:trigger="image-{{ $item->id }}">
