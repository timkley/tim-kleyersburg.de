<div>
    ...
    <form wire:submit="addExercise" class="space-y-2 mt-6 max-w-lg">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
            <flux:input class="col-span-2 sm:col-span-1" inputmode="numeric" wire:model="sets" placeholder="Sets" icon="clipboard-document-check" />
            <flux:input inputmode="numeric" wire:model="minReps" placeholder="Min. Wdh." icon="arrow-down" />
            <flux:input inputmode="numeric" wire:model="maxReps" placeholder="Max. Wdh." icon="arrow-up" />
        </div>
