...
use Modules\Holocron\School\Database\Factories\VocabularyTestFactory;

/**
 * @property-read Collection<int,int> $word_ids
 * @property-read Collection<int,int> $correct_ids
 * @property-read Collection<int,int> $wrong_ids
...
class VocabularyTest extends Model
{
    ...
    protected static function newFactory(): VocabularyTestFactory
    {
        return VocabularyTestFactory::new();
    }
